...
public class ClinicalFindingValue implements Serializable {
    ...
    private boolean requirePaymentBeforeLab; // Workflow A: true = must pay first, Workflow B: false = process immediately
    @ManyToOne
    ...
    public boolean isRequirePaymentBeforeLab() {
        return requirePaymentBeforeLab;
    }

    public void setRequirePaymentBeforeLab(boolean requirePaymentBeforeLab) {
        this.requirePaymentBeforeLab = requirePaymentBeforeLab;
    }
