...
public class PackageItemController implements Serializable {
    ...
    public void itemSelected() {
        // Auto-populate institution and department from selected item
        if (current != null && current.getItem() != null) {
            if (current.getItem().getInstitution() != null) {
                current.setInstitution(current.getItem().getInstitution());
            }
            if (current.getItem().getDepartment() != null) {
                current.setDepartment(current.getItem().getDepartment());
            }
        }
    }
