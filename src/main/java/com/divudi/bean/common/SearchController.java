...
public class SearchController implements Serializable {
    ...
    private String barcodeIdString;
...
//        billTypeAtomic.add(BillTypeAtomic.INWARD_SERVICE_BILL_CANCELLATION_DURING_BATCH_BILL_CANCELLATION);
    ...
    public String settleBillByBarcode() {
        // Try to parse the barcodeIdString to get the numeric ID
        if (barcodeIdString != null && !barcodeIdString.trim().isEmpty()) {
            try {
                // Remove any leading zeros and parse
                barcodeIdLong = Long.parseLong(barcodeIdString.trim());
            } catch (NumberFormatException e) {
                JsfUtil.addErrorMessage("Please scan the barcode or enter the numeric Bill ID");
                return "";
            }
        }
        
        if (barcodeIdLong == null) {
            JsfUtil.addErrorMessage("Please scan the barcode or enter the Bill ID");
            return "";
        }
...
//
    ...
    public String getBarcodeIdString() {
        return barcodeIdString;
    }

    public void setBarcodeIdString(String barcodeIdString) {
        this.barcodeIdString = barcodeIdString;
    }
